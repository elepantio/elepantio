        ...
        <div ref={ref} className="mt-16">
          <div className="relative overflow-hidden">
            ...
            >
              ...
              <motion.div
                ref={carouselRef}
                className="absolute flex gap-8 py-8"
                initial={{ x: 0 }}
                animate={{
                  x: isPaused ? undefined : [0, -1 * (techStack.length * 192)],
                }}
                transition={{
              ...
              <motion.div
                className="absolute top-[110px] flex gap-8 py-8"
                initial={{ x: -1 * (techStack.length * 192) }}
                animate={{
                  x: isPaused ? undefined : [0, -1 * (techStack.length * 192)],
                }}
                transition={{
                  ...
                  ease: "linear",
                  repeatDelay: 0,
                  direction: "reverse", // Move in opposite direction
                }}
              >
                {duplicatedTechStack.map((tech, index) => (
                  <motion.div
