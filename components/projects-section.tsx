...
export default function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      link: "/projects/grorex-dashboard",
      description:
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col justify-center">
                ...
                <p className="mb-4 text-xl font-light text-purple-600 dark:text-purple-300">
                  {project.subtitle}
                </p>
                ...
                <Link href={project.link}>
                  <Button
                    className={`w-fit bg-gradient-to-r ${project.gradient} text-white hover:opacity-90`}
                    size="sm"
                  >
